...
class __Mustache_19c209d4b250bff5d81f322c470b4600 extends Mustache_Template
{
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_enlightlite/header')) {
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_enlightlite/footer')) {
            $buffer .= $partial->renderInternal($context);
        }
        $buffer .= $indent . '
';
