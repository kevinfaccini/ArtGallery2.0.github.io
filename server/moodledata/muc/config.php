<?php defined('MOODLE_INTERNAL') || die();
 $configuration = array (
  'siteidentifier' => '1101c55ec9eef5c0a27372361078ed54',
  'stores' => 
  array (
    'default_application' => 
    array (
  ...
  array (
    ...
    'theme_adaptable/activitystudentrolescache' => 
    array (
      'mode' => 1,
      'simplekeys' => true,
      'simpledata' => true,
      ...
      'area' => 'activitystudentrolescache',
      'selectedsharingoption' => 2,
      'userinputsharingkey' => '',
    ),
    'theme_adaptable/activitymodulecountcache' => 
    array (
      'mode' => 1,
      'simplekeys' => true,
      'simpledata' => true,
      'staticacceleration' => true,
      'component' => 'theme_adaptable',
      'area' => 'activitymodulecountcache',
      'selectedsharingoption' => 2,
      'userinputsharingkey' => '',
    ),
    'theme_adaptable/activitystudentscache' => 
    array (
      'mode' => 1,
      'simplekeys' => true,
      'simpledata' => true,
      'staticacceleration' => true,
      'component' => 'theme_adaptable',
      'area' => 'activitystudentscache',
      'selectedsharingoption' => 2,
      'userinputsharingkey' => '',
    ),
    'theme_adaptable/activityusercreatedcache' => 
    array (
      'mode' => 1,
      'simplekeys' => true,
      'simpledata' => true,
